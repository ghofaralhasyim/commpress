...
<head>
    ...
    <title>Media Commpress Dasboard</title>
</head>
<body>
            ...
            <div class="sideNav">
               ...
               <?php foreach($pameran as $data): ?>
                    <div class="sideNav__menu">
                        <a style="text-decoration: none;" href="<?php base_url() ?>/dashboard-media/content" class="sideNav__link <?php if(!strcmp($url,"dashboard-media/content")){echo 'active';} ?>">
