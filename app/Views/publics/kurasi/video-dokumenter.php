            ...
            <div class="karya pt-24">
               ...
               <div class="karya-image mt-24 flex h-center">
                    <iframe width="100%"
                        ...
                        src="https://www.youtube.com/embed/<?= $popup['url'] ?>" 
                        title="<?= $popup['title'] ?>" 
   ...
   <section class="foto-tunggal">
      <div class="banner">
        <div class="container">
            ...
            <h1 class="subtitle mt-0">VIDEO DOKUMENTER</h1>
        </div>
      </div>
      ...
      <div class="container pb-12 pt-32">
         <div class="flex flex-col md-flex-row pt-24 photo-wrapper row-gap-18">
            ...
            <div class="photo-card" onclick="toggleDetails(<?= $data['id_submission']; ?>)">
                  <img src="<?= base_url('/uploads/submission/video-dokumenter/').'/'.$data['thumbnail_karya'] ?>" loading="lazy" alt="">
